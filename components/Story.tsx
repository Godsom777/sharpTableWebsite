            ...
            <div className="flex-1 flex items-center justify-center relative">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className={`${steps[currentStep].view.bgColor} border ${steps[currentStep].view.borderColor} p-8 rounded-2xl shadow-2xl w-full`}
                >
                  ...
                  <motion.div
                    ...
                    className="absolute top-4 right-4 w-8 h-8 bg-white/10 backdrop-blur-sm rounded-full flex items-center justify-center text-white text-xs font-bold"
                  >
                    {currentStep + 1}
                  </motion.div>
                </motion.div>
              ...
              <motion.div
                ...
                className="absolute bottom-0 right-0 bg-amber-900/10 border border-amber-900/30 p-4 rounded-xl max-w-xs"
              >
